...
func (m streamStatusDSStub) CallEditMessage(_ context.Context, _ *auth.RequestAuth, _ any, _ string, _ int) (*http.Response, error) {
        return nil, fmt.Errorf("CallEditMessage not implemented in stub")
}
...
func (m *inlineUploadDSStub) CallEditMessage(_ context.Context, _ *auth.RequestAuth, _ any, _ string, _ int) (*http.Response, error) {
        return nil, fmt.Errorf("CallEditMessage not implemented in stub")
}
