...
func (c Config) MarshalJSON() ([]byte, error) {
        ...
        if c.OutputIntegrityGuard.Enabled != nil {
                m["output_integrity_guard"] = c.OutputIntegrityGuard
        }
...
func (c *Config) UnmarshalJSON(b []byte) error {
        ...
        for k, v := range raw {
                ...
                case "output_integrity_guard":
                        if err := json.Unmarshal(v, &c.OutputIntegrityGuard); err != nil {
                                return fmt.Errorf("invalid field %q: %w", k, err)
                        }
                case "vercel":
...
func (c Config) Clone() Config {
        clone := Config{
                ...
                OutputIntegrityGuard: OutputIntegrityGuardConfig{
                        Enabled: cloneBoolPtr(c.OutputIntegrityGuard.Enabled),
                },
                Vercel:           c.Vercel,
