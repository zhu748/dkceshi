...
const toolsTranscriptSummary = "Catalogue of invokable functions and their parameter contracts for this turn."
...
func injectToolPromptWithDescriptions(messages []map[string]any, tools []any, policy ToolChoicePolicy, includeDescriptions bool) ([]map[string]any, []string) {
	...
	if includeDescriptions && parts.Descriptions != "" {
		...
		toolPrompt = "tool_schema.txt carries the full set of invokable function definitions and parameter contracts for this turn. Trust exclusively the functions and parameter shapes enumerated there and do not improvise any that are not declared.\n\n" + toolPrompt
	}
...
func buildToolPromptParts(tools []any, policy ToolChoicePolicy) toolPromptParts {
	...
	descriptions := "These tools are available for this turn:\n\n" + strings.Join(toolSchemas, "\n\n")
